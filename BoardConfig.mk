...
TARGET_PREBUILT_KERNEL := device/samsung/tbltekdi/zImage
TARGET_PREBUILT_DTB := device/samsung/tbltekdi/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/tbltekdi/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/tbltekdi/init/init_tbltekdi.cpp
